...
안녕하세요. 데이터를 단순히 분석하는 것을 넘어, 부족한 부분을 스스로 개선하며 성장하는 데이터 분석가 **서민석**입니다.
...
- **주제:** 고객 특성 분석을 통한 소비 패턴 이해 및 마케팅 전략 제안
- **기술:** R, Tableau
- **주요 분석:** 다중회귀분석, 모델 진단, Tableau Dashboard
...
📂 **[EPL-Match-Analysis](./EPL-Match-Analysis)**
